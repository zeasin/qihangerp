package cn.qihangerp.api.controller.dou;
...
//    private ErpSalesOrderService salesOrderService;
    ...
    public ApiResult<cn.qihangerp.api.controller.dou.ErpSalesPullCountResp> getOrderList(cn.qihangerp.api.controller.dou.DouRequest reqData, HttpServletRequest req) throws Exception {
        ...
        ApiResult<cn.qihangerp.api.controller.dou.ErpSalesPullCountResp> result=null;//返回结果
...
//        startTime = 1587966628L;endTime = startTime + 60 * 30;
    ...
    private ApiResult<cn.qihangerp.api.controller.dou.ErpSalesPullCountResp> editDouyinOrder(Long startTime, Long endTime, Long shopId) throws Exception{
...
//                    else if(result.getCode() == EnumResultVo.SUCCESS.getIndex()) addCount++;
        ...
        cn.qihangerp.api.controller.dou.ErpSalesPullCountResp resp = new cn.qihangerp.api.controller.dou.ErpSalesPullCountResp();//返回结果
