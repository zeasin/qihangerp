...
CREATE TABLE `s_shop`  (
  ...
  `sellerUserIdStr` varchar(50)  NOT NULL COMMENT '卖家userId',
  `sessionKey` varchar(100)  NULL DEFAULT NULL COMMENT '第三方平台sessionKey',
  `appkey` varchar(100)  NULL DEFAULT NULL COMMENT 'Appkey暂时抖音用',
  `appSercet` varchar(100)  NULL DEFAULT NULL COMMENT 'Appsercet暂时抖音用',
  PRIMARY KEY (`id`) 
) 
